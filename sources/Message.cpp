...
void				Message::reply(Server & serv, User &user, unsigned short code, std::string nickname)
{
...
std::string			Message::get_reply(unsigned short code, std::string servername, std::string nickname) {
	//std::string target;
