...
string ft_RPL_WHOREPLY(string arg1, string arg2, string arg3, string arg4, string arg5, string arg6, string arg7) { return (channel + " " + user + " " + host + " " + server + " " + nick + " " + state + " :0 " + real; }
